        ...
        <div className="p-4 sm:p-6 lg:p-8 overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            <div>
              ...
              <PhoneInput className='w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition text-sm sm:text-base'/>
            </div>
