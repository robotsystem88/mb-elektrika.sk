...
import { Battery, Wrench, CheckCircle2, AlertTriangle, Zap, PiggyBank } from 'lucide-react';
...
export function BatteryInfo() {
  ...
  return (
    <section id="battery" className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">{t('batteryInfo', 'title')}</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative group">
              ...
              <div className="relative bg-gray-900 rounded-xl overflow-hidden h-[250px] sm:h-[400px] lg:h-[500px]">
                <img
                  src="https://images.unsplash.com/photo-1635773054018-1d68618f979c?auto=format&fit=crop&q=80&w=1200&h=800"
                  alt="Mercedes Battery"
                  className="w-full h-full object-cover transform scale-105 group-hover:scale-110 transition-transform duration-700 brightness-75"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/80 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                  <div className="flex items-center gap-3 mb-3 bg-yellow-500/20 px-4 py-2 rounded-lg backdrop-blur-sm inline-flex border border-yellow-500/30">
                    <Battery className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500" />
                    <span className="text-yellow-500 font-semibold">{t('batteryInfo', 'batteryType')}</span>
                  </div>
            ...
            <div className="space-y-6">
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 hover:bg-white/10 transition-colors border border-white/10">
                <h3 className="text-xl font-semibold mb-4 text-yellow-500">{t('batteryInfo', 'mainProblemTitle')}</h3>
              ...
              <div className="bg-yellow-500/10 rounded-xl p-6 border border-yellow-500/20">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold">{t('batteryInfo', 'importantTitle')}</h3>
                </div>
        ...
        <div className="mt-12 sm:mt-20 relative">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">{t('batteryInfo', 'solution.title')}</h2>
            <p className="text-gray-400 max-w-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
              ...
              <div className="sticky top-8">
                <div className="relative rounded-2xl overflow-hidden group h-[300px] sm:h-[400px]">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <p className="text-base sm:text-lg font-semibold mb-2">{t('batteryInfo', 'solution.equipment.title')}</p>
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6">
              {Object.values(t('batteryInfo', 'solution.features') || []).map((item: any, index: number) => (
                <div 
                  key={index}
                    ...
                    <div className="flex-shrink-0 w-12 h-12 bg-yellow-500/10 rounded-xl flex items-center justify-center group-hover:bg-yellow-500/20 transition-colors">
                      <div className="text-yellow-500">
                        {index === 0 ? <CheckCircle2 className="w-6 h-6" /> :
                         index === 1 ? <Wrench className="w-6 h-6" /> :
